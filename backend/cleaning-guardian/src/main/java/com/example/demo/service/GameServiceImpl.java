...
public class GameServiceImpl implements GameService {
	 ...
	 * @return a StageDTO containing the cleared stages and user email if found; otherwise, a failure response with an appropriate message
	 */
	@Override
	 ...
	 * @return a CampaignsDTO containing the list of campaigns and a success status; if no campaigns are found, returns a failure status with an appropriate message
	 */
	@Override

    ...
    ${({ $unlocked }) =>
        ...
        css`
            &:hover {
                ...
                box-shadow: 0 8px 20px rgba(76, 175, 80, 0.4), inset 0 2px 4px rgba(255, 255, 255, 0.5),
                    inset 0 -2px 4px rgba(0, 0, 0, 0.3), 0 0 0 3px rgba(255, 255, 255, 0.2);
                background: linear-gradient(
                    135deg,
                    rgba(76, 175, 80, 1) 0%,
                    rgba(104, 195, 108, 1) 50%,
                    rgba(129, 199, 132, 1) 100%
                );
                letter-spacing: 3px;
            }
            ...
            &:active {
                ...
                box-shadow: 0 2px 8px rgba(76, 175, 80, 0.3), inset 0 2px 4px rgba(255, 255, 255, 0.2),
                    inset 0 -2px 4px rgba(0, 0, 0, 0.4), 0 0 0 2px rgba(255, 255, 255, 0.1);
                background: linear-gradient(
                    135deg,
                    rgba(69, 160, 73, 1) 0%,
                    rgba(76, 175, 80, 1) 50%,
                    rgba(104, 195, 108, 1) 100%
                );
                letter-spacing: 2px;
            }
        `}
